...
############### create sets of common adjectives, adverbs, verbs used later in substitute
file = "/Volumes/My_Passport/Documents/FakeNewsDetection/Data/adj_adv_verb/adjectives.txt"

input_file = open(file, 'r')
lines = input_file.readlines()

lines = [word[:-1] for word in lines]
adjectives = set(lines)


file = "/Volumes/My_Passport/Documents/FakeNewsDetection/Data/adj_adv_verb/adverbs.txt"
...
file = "/Volumes/My_Passport/Documents/FakeNewsDetection/Data/adj_adv_verb/verbs.txt"
...
class SynonymAug(WordAugmenter):
    ...
    def __init__(self, aug_src='wordnet', model_path=None, name='Synonym_Aug', aug_min=100, aug_max=1000, aug_p=0.3,
    ...
    def substitute(self, data):
        ...
        for aug_idx in aug_idxes:
            ...
            #continue if not adjective, adverb, or verb
            if (original_token not in adjectives and
                original_token not in adverbs and
                original_token not in verbs):
                continue

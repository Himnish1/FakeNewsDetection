...
class SynonymAug(WordAugmenter):
    ...
    def __init__(self, aug_src='wordnet', model_path=None, name='Synonym_Aug', aug_min=1, aug_max=200, aug_p=0.3,
    ...
    def substitute(self, data):
        ...
        for aug_idx in aug_idxes:
            ...
            if original_token not in adjectives 
                and original_token not in adverbs
                and original token not in verbs:
                continue
